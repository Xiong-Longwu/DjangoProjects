;console.log('源代码唯一下载链接: http://www.bootstrapmb.com/item/12865(此说明不在下载的源码里，只用在演示页面里) ');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('stra')<0){location.href='http://www.bootstrapmb.com/item/12865'}};/*!
  * Bootstrap v5.0.1 (https://getbootstrap.com/)
  * ���������HTML5ģ�壺http://www.bootstrapmb.com
